(defproject kigen-engine "0.1.0-SNAPSHOT"
  ...
  :profiles {:uberjar {:aot :all}
             ...
             ;; windows-x86 support
             :natives-windows-x86 {:dependencies [[org.lwjgl/lwjgl "3.3.3" :classifier "natives-windows-x86"]
             ...
             :natives-windows-amd64 {:dependencies [[org.lwjgl/lwjgl "3.3.3" :classifier "natives-windows"]
             ...
             ;; linux-amd64 support
             :natives-linux-amd64 {:dependencies [[org.lwjgl/lwjgl "3.3.3" :classifier "natives-linux"]
             ...
             ;; linux-arm64 support
             :natives-linux-arm64 {:dependencies [[org.lwjgl/lwjgl "3.3.3" :classifier "natives-linux-arm64"]
             ...
             ;; linux-arm32 support
             :natives-linux-arm32 {:dependencies [[org.lwjgl/lwjgl "3.3.3" :classifier "natives-linux-arm32"]
